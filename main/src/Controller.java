...
public class Controller {
    ...
    void newAccount(String name, String balance, String email, String description, String phoneNumber) {
        account.addAccount(new String[] {name, balance, email, description, "False", phoneNumber});
    }
